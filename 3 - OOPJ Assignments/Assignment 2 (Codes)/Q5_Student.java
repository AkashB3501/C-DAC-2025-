...
class Q5_Student {
    ...
    Q5_Student(String name, int marks) {
        this.name = name;
        this.marks = marks;
        totalStudents++;
    }
    ...
    public static void main(String args[]) {
        ...
        Q5_Student s1 = new Q5_Student("Rahul", 78);
        Q5_Student s2 = new Q5_Student("Pooja", 34);
        Q5_Student s3 = new Q5_Student("Amit", 65);
...
/*
PS D:\0 - CDAC 2025\Assignment 2 (Codes)> javac  Q5_Student.java
PS D:\0 - CDAC 2025\Assignment 2 (Codes)> java  Q5_Student
Student Rahul Passed? true
Student Pooja Passed? false
Student Amit Passed? true
Total Students: 3
